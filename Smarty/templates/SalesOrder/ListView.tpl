      ...
      <tbody>
        <tr>
              <td style="padding-left:5px;">
                 <input title="{$MOD.LNK_NEW_SO}" class="crmbutton small create" onclick="javascript:location.href='index.php?module=SalesOrder&action=EditView'" type="button" name="Create" value="{$APP.LNK_NEW_SO}">&nbsp;
               </td> 
