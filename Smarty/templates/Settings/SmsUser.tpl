	...
	<div align=center>
			...
			<input type="hidden" name="action" value="SmsUser">
                        ...
                        <tr>
                            ...
                            <td  width="10%" align="left"><input type="text" value="{$user_name}" name="user_name"  size="18" style="border:1px solid #bababa;" tabindex="13"/></td>
                            <td  width="5%" align="right" nowrap="nowrap">姓名：</td> 
                            <td  width="10%"><input type="text" value="{$last_name}" name="last_name"  size="13" style="border:1px solid #bababa;" tabindex="13"/></td>
							<td  width="5%" align="right" nowrap="nowrap">手机：</td> 
                            <td  width="10%"><input type="text" value="{$phone_mobile}" name="phone_mobile"  size="13" style="border:1px solid #bababa;" tabindex="13"/></td>
							<td  width="5%" align="right" nowrap="nowrap">Email：</td> 
                            <td  width="10%"><input type="text" value="{$email1}" name="email1"  size="13" style="border:1px solid #bababa;" tabindex="13"/></td>
