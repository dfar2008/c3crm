...
<form name="uploadform" method="POST" ENCTYPE="multipart/form-data" action="uploadfileInfo.php" style="margin:0px">
        ...
        <input id="viewname" name="viewname" type="hidden" value="">
				...
				<input name="interval" id="interval" value="{$interval}" type="hidden">
                                </td>
                                </tr>
                                <tr>
                                <td>
				...
				<br>
				<input type="button" name="savebutton" id="savebutton" value="&nbsp;&nbsp;&nbsp;&nbsp;群发&nbsp;&nbsp;&nbsp;&nbsp; "   class="crmbutton small edit" onclick="SendMailToAll('Maillists','{$sjid}','KE');return false;" />
                                </td>
                                </tr>
                                <tr>
                                <td>
