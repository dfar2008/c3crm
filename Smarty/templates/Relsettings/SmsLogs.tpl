...
<tbody>
	...
	<div align=center>
				...
				<tr>
					...
					<td class=heading2 valign=bottom><b><a href="index.php?module=Relsettings&action=index&parenttab=Settings">{$MOD.LBL_RELSETTINGS}</a> > {$MOD.LBL_SMS_LOGS} </b></td>
				</tr>
				<tr>
					<td valign=top class="small">{$MOD.LBL_SMS_LOGS} </td>
				</tr>
				</table>
