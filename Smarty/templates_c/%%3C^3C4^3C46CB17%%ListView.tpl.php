...
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'Accounts/ListView.tpl', 99, false),)), $this); ?>
                ...
                <div id="collapseOne" class="accordion-body collapse in" >
                  <div class="accordion-inner">
                      <div id="right_column_assort" style="display:; padding:15px;" class="rightcolumnlink">
                        <img src="themes/bootcss/img/vtbusy.gif" title="<?php echo $this->_tpl_vars['MOD']['LBL_INITIALIZING']; ?>
"/>
                      </div>
                  </div>
                </div>
