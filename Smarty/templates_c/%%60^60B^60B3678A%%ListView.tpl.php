<?php /* Smarty version 2.6.18, created on 2013-05-10 11:29:35
         compiled from Memdays/ListView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'Memdays/ListView.tpl', 112, false),)), $this); ?>
      ...
      <tbody>
        <tr>
              <td style="padding-left:5px;">
                 <input class="crmbutton small create" onclick="javascript:location.href='index.php?module=<?php echo $this->_tpl_vars['MODULE']; ?>
...
">&nbsp;
		 <input class="crmbutton small edit" onclick="javascript:location.href='index.php?module=Relsettings&action=MemdayConfig&parenttab=Settings'" type="button" name="edit" value="设置提醒">&nbsp;
               </td> 
