...
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'Accounts/ListViewEntries.tpl', 106, false),)), $this); ?>
				...
				<td>
                  ...
                  <table border=0 cellspacing=0 cellpadding=2 width=100% class="small" >
                    ...
                    <!-- Buttons -->
                        ...
                        <a id="moreoperate" href="index.php?module=Accounts&action=index" target="main" onmouseover="fnDropDown(this,'selectoperate');" onmouseout="fnHideDrop('selectoperate');" >批量操作<img border="0" src="themes/images/collapse.gif"></a>
                         </td>
