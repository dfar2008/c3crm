<?php /* Smarty version 2.6.18, created on 2013-05-10 11:30:06
         compiled from Qunfas/ListViewEntries.tpl */ ?>
                          ...
                          <tr>
                              ...
                              <table cellspacing="0" cellpadding="3" border="0">
                                ...
                                <td>
                                 <p>
                                  ...
                                  7.<font color=red>每行一个客户</font><br><br>
                            ...
                            <td  valign="top" bgcolor="#EFEFEF" align="center" width="20%">
                              <table cellspacing="0" cellpadding="3" border="0">
                                ...
                                <td valign="top">
                                <p align="center">
                                <textarea style="line-height: 150%;width: 240px; height: 380px;" cols="35" name="dst" rows="8" id="receiveaccountinfo" ><?php echo $this->_tpl_vars['receiveaccountinfo']; ?>
</textarea>
                                </p>
                                </td>
                                </tr>
                            ...
                            <td valign="top" bgcolor="#EFEFEF" align="center" width="20%">
                                ...
                                <?php $_from = $this->_tpl_vars['QUNFATMPS']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['tpl']):
?>
                               	 <option value="<?php echo $this->_tpl_vars['tpl'][2]; ?>
"><?php echo $this->_tpl_vars['tpl'][1]; ?>
</option>
                                ...
                                <div>选择开始发送时间: &nbsp;
                                  <input id="jscal_field_sendtime" type="text" value="" maxlength="10" size="16" name="sendtime" readonly="readonly">
<img id="jscal_trigger_sendtime" onclick="javascript:displayCalendar('jscal_field_sendtime',this,true)" src="themes/softed/images/calendar.gif"></div> <br />
    ...
    4.<font color=red>短信内容不能多于48个字（其中空格，数字，字母，汉字均为一个字）</font><br><br>
                                ...
                                <!--<input type="button" name="button" value="测试发送给自己"  onclick="SendMessToSelf('Qunfas');return false;" ><-->
                                 <input type="button" name="savebutton" id="savebutton" value="&nbsp;&nbsp;&nbsp;&nbsp;群发&nbsp;&nbsp;&nbsp;&nbsp; "  class="small crmbutton save" onclick="SendMessToAll('Qunfas');return false;"  />
                                </td>
                                </tr>
                                </tbody>
                                </table>
