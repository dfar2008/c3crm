...
function set_return_specific(id, name) {
        window.opener.document.EditView.relsettingname.value = name;
        window.opener.document.EditView.relsettingsid.value = id;
}
...
{
	window.open("index.php?module=Products&action=PopupForModules&html=Popup_picker&popuptype=inventory_prods&select=enable&modules=Relsettings","productWin","width=740,height=565,resizable=1,scrollbars=1,status=1,top=150,left=200");	
}
