...
function set_return_specific(id, name) {
        window.opener.document.EditView.qunfaname.value = name;
        window.opener.document.EditView.qunfasid.value = id;
}
...
{
	window.open("index.php?module=Products&action=PopupForModules&html=Popup_picker&popuptype=inventory_prods&select=enable&modules=Qunfas","productWin","width=740,height=565,resizable=1,scrollbars=1,status=1,top=150,left=200");	
}
