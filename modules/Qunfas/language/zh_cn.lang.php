 ...
 ********************************************************************************/
$mod_strings = array (
  'LBL_MODULE_NAME' => '客户回访',
  'LBL_MODULE_TITLE' => '客户回访: 首页',
  'LBL_SEARCH_FORM_TITLE' => '查找客户回访',
  'LBL_LIST_FORM_TITLE' => '客户回访列表',
  'LBL_NEW_FORM_TITLE' => '新增客户回访',
  'ERR_DELETE_RECORD' => '必须指定记录编号才能删除客户.',
  'LBL_QUNFA_INFORMATION' => '基本信息',
  'LBL_CUSTOM_INFORMATION' => '自定义信息',
  'LBL_DESCRIPTION_INFORMATION' => '描述信息',
  'LBL_TOOL_FORM_TITLE' => '客户回访工具',
  'Created Time' => '创建时间',
  'Modified Time' => '修改时间',
