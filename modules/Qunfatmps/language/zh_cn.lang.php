 ...
 ********************************************************************************/
$mod_strings = array (
  'LBL_MODULE_NAME' => '短信模板',
  'LBL_MODULE_TITLE' => '短信模板: 首页',
  'LBL_SEARCH_FORM_TITLE' => '查找短信模板',
  'LBL_LIST_FORM_TITLE' => '短信模板列表',
  'LBL_NEW_FORM_TITLE' => '新增短信模板',
  'ERR_DELETE_RECORD' => '必须指定记录编号才能删除客户.',
  'LBL_QUNFATMP_INFORMATION' => '基本信息',
  'LBL_CUSTOM_INFORMATION' => '自定义信息',
  'LBL_DESCRIPTION_INFORMATION' => '描述信息',
  'LBL_TOOL_FORM_TITLE' => '短信模板工具',
  'Created Time' => '创建时间',
  'Modified Time' => '修改时间',
