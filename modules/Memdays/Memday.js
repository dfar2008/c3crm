...
function validateInventory() 
{
	...
	if(document.EditView.memday938.value == '请选择'){
		alert("请选择一个纪念日类型");return false;
	}
	if(document.EditView.memday942.value == ''){
		alert("月 不能为空");return false;
	}
	if(document.EditView.memday944.value == ''){
		alert("日 不能为空");return false;
	}
...
function setDaysOpts(days){
	...
	var daysobj = document.EditView.memday944;
