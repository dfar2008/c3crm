 ...
 ********************************************************************************/
$mod_strings = array (
  'LBL_MODULE_NAME' => '群发邮件',
  'LBL_MODULE_TITLE' => '群发邮件: 首页',
  'LBL_SEARCH_FORM_TITLE' => '查找群发邮件',
  'LBL_LIST_FORM_TITLE' => '群发邮件列表',
  'LBL_NEW_FORM_TITLE' => '新增群发邮件',
  'ERR_DELETE_RECORD' => '必须指定记录编号才能删除客户.',
  'LBL_MAILLIST_INFORMATION' => '基本信息',
  'LBL_CUSTOM_INFORMATION' => '自定义信息',
  'LBL_DESCRIPTION_INFORMATION' => '描述信息',
  'LBL_TOOL_FORM_TITLE' => '群发邮件工具',
  'Created Time' => '创建时间',
  'Modified Time' => '修改时间',
